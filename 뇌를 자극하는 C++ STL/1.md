...
int main()
{
	...
	obj(10, 20);		// 객체 생성 후 호출 (암시적)
	obj(10, 20, 30);	// 객체 생성 후 호출 (암시적)
	cout << endl;

	obj.operator()(10);			// 객체 생성 후 호출 (명시적)
	obj.operator()(10, 20);		// 객체 생성 후 호출 (명시적)
	obj.operator()(10, 20, 30); // 객체 생성 후 호출 (명시적)
	cout << endl;

	FuncObject()(10);		  // 임시 객체로 호출 (암시적)
	FuncObject()(10, 20);	  // 임시 객체로 호출 (암시적)
	FuncObject()(10, 20, 30); // 임시 객체로 호출 (암시적)
	cout << endl;

	FuncObject()(10);		  // 임시 객체로 호출 (명시적)
	FuncObject()(10, 20);	  // 임시 객체로 호출 (명시적)
	FuncObject()(10, 20, 30); // 임시 객체로 호출 (명시적)
	cout << endl;
